...
class Jurubeli1_2Controller extends Controller
{
    // Halaman utama daftar dokumen
    public function index()
    {
        $dokumen = Dokumen::where('status_verifikasi', 'Menunggu Juru Beli 2')->get();
        return view('Jurubeli1_2.index', compact('dokumen'));
    }
...
public function setujui(Request $request, $id)
{
    ...
    DB::table('histori_verifikasi')->insert([
        ...
        'tanggal_keluar' => now(),
        'catatan' => "Disetujui oleh Juru Beli 2 dan diteruskan ke " . str_replace('_', ' ', $next) . " ",
    ]);
    ...
    public function tolak(Request $request, $id)
    {
        ...
        return redirect()->route('Jurubeli1_2.index')->with('error', 'Dokumen ditolak dan dikembalikan ke vendor.');
    }
}
