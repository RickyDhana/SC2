...
class Jurubeli1_8Controller extends Controller
{
    // Halaman utama daftar dokumen
    public function index()
    {
        $dokumen = Dokumen::where('status_verifikasi', 'Menunggu Juru Beli 8')->get();
        return view('Jurubeli1_8.index', compact('dokumen'));
    }
...
public function setujui(Request $request, $id)
{
    ...
    DB::table('histori_verifikasi')->insert([
        ...
        'tanggal_keluar' => now(),
        'catatan' => "Disetujui oleh Juru Beli 8 dan diteruskan ke " . str_replace('_', ' ', $next) . " ",
    ]);
    ...
    public function tolak(Request $request, $id)
    {
        ...
        $dokumen->status_verifikasi = 'Ditolak Jurubeli 8';
        ...
        return redirect()->route('Jurubeli1_8.index')->with('error', 'Dokumen ditolak dan dikembalikan ke vendor.');
    }
}
