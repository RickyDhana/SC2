...
class Jurubeli1_11Controller extends Controller
{
    // Halaman utama daftar dokumen
    public function index()
    {
        $dokumen = Dokumen::where('status_verifikasi', 'Menunggu Juru Beli 11')->get();
        return view('Jurubeli1_11.index', compact('dokumen'));
    }
...
public function setujui(Request $request, $id)
{
    ...
    DB::table('histori_verifikasi')->insert([
        ...
        'tanggal_keluar' => now(),
        'catatan' => "Disetujui oleh Juru Beli 11 dan diteruskan ke " . str_replace('_', ' ', $next) . " ",
    ]);
    ...
    public function tolak(Request $request, $id)
    {
        ...
        $dokumen->status_verifikasi = 'Ditolak Jurubeli 11';
        ...
        return redirect()->route('Jurubeli1_11.index')->with('error', 'Dokumen ditolak dan dikembalikan ke vendor.');
    }
}
