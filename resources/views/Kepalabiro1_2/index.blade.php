    ...
    <main class="p-6">
        <div class="max-w-screen-2xl mx-auto">
            <h2 class="text-2xl font-bold mb-6 text-white">
                Daftar Dokumen Menunggu Verifikasi Kepala Biro 2
            </h2>
        ...
        function openDetailModal(id) {
            fetch(`/Kepalabiro1_2/${id}/json`)
                ...
                .then(data => {
                    ...
                    document.getElementById('formSetujui').action = `/Kepalabiro1_2/${data.id}/setujui`;
                    document.getElementById('formTolak').action = `/Kepalabiro1_2/${data.id}/tolak`;
