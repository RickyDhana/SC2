        ...
        function openDetailModal(id) {
            fetch(`/Jurubeli1_12/${id}/json`)
                ...
                .then(data => {
                    ...
                    document.getElementById('formSetujui').action = `/Jurubeli1_12/${data.id}/setujui`;
                    document.getElementById('formTolak').action = `/Jurubeli1_12/${data.id}/tolak`;
