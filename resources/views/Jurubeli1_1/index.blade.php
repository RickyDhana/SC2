...
<head>
    ...
    <title>Dashboard Jurubeli 1</title>
        ...
        function openDetailModal(id) {
            fetch(`/Jurubeli1_1/${id}/json`)
                ...
                .then(data => {
                    ...
                    document.getElementById('formSetujui').action = `/Jurubeli1_1/${data.id}/setujui`;
                    document.getElementById('formTolak').action = `/Jurubeli1_1/${data.id}/tolak`;
