        ...
        function openDetailModal(id) {
            fetch(`/Jurubeli1_5/${id}/json`)
                ...
                .then(data => {
                    ...
                    document.getElementById('formSetujui').action = `/Jurubeli1_5/${data.id}/setujui`;
                    document.getElementById('formTolak').action = `/Jurubeli1_5/${data.id}/tolak`;
