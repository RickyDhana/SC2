        ...
        function openDetailModal(id) {
            fetch(`/Jurubeli1_11/${id}/json`)
                ...
                .then(data => {
                    ...
                    document.getElementById('formSetujui').action = `/Jurubeli1_11/${data.id}/setujui`;
                    document.getElementById('formTolak').action = `/Jurubeli1_11/${data.id}/tolak`;
