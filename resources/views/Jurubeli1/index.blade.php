    ...
    function openDetailModal(id) {
        fetch(`/Jurubeli1/${id}/json`)
            ...
            .then(data => {
                ...
                // Set action form
                document.getElementById('formSetujui').action = `/Jurubeli1/${data.id}/setujui`;
                document.getElementById('formTolak').action = `/Jurubeli1/${data.id}/tolak`;
