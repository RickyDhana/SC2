        ...
        function openDetailModal(id) {
            fetch(`/Jurubeli1_10/${id}/json`)
                ...
                .then(data => {
                    ...
                    document.getElementById('formSetujui').action = `/Jurubeli1_10/${data.id}/setujui`;
                    document.getElementById('formTolak').action = `/Jurubeli1_10/${data.id}/tolak`;
