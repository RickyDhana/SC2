...
<head>
    ...
    <title>Dashboard Kepala Departemen</title>
...
<body class="bg-[#0a1730] text-white min-h-screen">
    ...
    <main class="p-6">
        <div class="max-w-screen-2xl mx-auto">
            <h2 class="text-2xl font-bold mb-6 text-white">
                Daftar Dokumen Menunggu Verifikasi Kepala Departemen
            </h2>
    ...
    <script>
        ...
        function openDetailModal(id) {
            fetch(`/KepalaDepartemen/${id}/json`)
                .then(res => res.json())
                .then(data => {
                    ...
                    document.getElementById('formSetujui').action = `/KepalaDepartemen/${data.id}/setujui`;
                    document.getElementById('formTolak').action = `/KepalaDepartemen/${data.id}/tolak`;
