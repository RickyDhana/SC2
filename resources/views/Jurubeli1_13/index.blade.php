        ...
        function openDetailModal(id) {
            fetch(`/Jurubeli1_13/${id}/json`)
                ...
                .then(data => {
                    ...
                    document.getElementById('formSetujui').action = `/Jurubeli1_13/${data.id}/setujui`;
                    document.getElementById('formTolak').action = `/Jurubeli1_13/${data.id}/tolak`;
