...
<head>
    ...
    <title>PT PAL - Supply Chain</title>
        ...
        <header class="bg-gradient-to-r from-[#1c2e55] via-[#132445] to-[#0a1730] shadow-md mb-8">
            <div class="container mx-auto flex justify-between items-center px-6 py-5">
                ...
                <nav class="flex items-center space-x-6">
                    ...
                    <a href="{{ url('login') }}"
                        class="border border-white px-4 py-2 rounded-md hover:bg-white hover:text-[#0a1730] transition text-sm">Login</a>
                </nav>
            </div>
        </header>
                ...
                <table id="userTable" class="min-w-full text-sm" style="width:100%">
                    <thead class="bg-[#1e2a47]">
                        <tr>
                            ...
                            <th class="px-4 py-3 font-semibold text-center tracking-wider">Juru Beli</th>
            ...
            <script>
                $(document).ready(function () {
                    var table = $('#userTable').DataTable({
                        ...
                        lengthChange: false,
                        ordering: false,
                        dom: 'rt<"flex justify-between mt-4"ip>'
                    });
