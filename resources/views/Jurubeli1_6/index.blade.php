        ...
        function openDetailModal(id) {
            fetch(`/Jurubeli1_6/${id}/json`)
                ...
                .then(data => {
                    ...
                    document.getElementById('formSetujui').action = `/Jurubeli1_6/${data.id}/setujui`;
                    document.getElementById('formTolak').action = `/Jurubeli1_6/${data.id}/tolak`;
