        ...
        function openDetailModal(id) {
            fetch(`/Jurubeli1_8/${id}/json`)
                ...
                .then(data => {
                    ...
                    document.getElementById('formSetujui').action = `/Jurubeli1_8/${data.id}/setujui`;
                    document.getElementById('formTolak').action = `/Jurubeli1_8/${data.id}/tolak`;
