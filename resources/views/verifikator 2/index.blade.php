...
<head>
    ...
    <title>Dashboard Verifikator 2 - PT PAL</title>
...
<body class="bg-[#0a1730] text-white min-h-screen">
    ...
    <header class="bg-gradient-to-r from-[#1c2e55] to-[#0a1730] shadow-md p-4 flex justify-between">
        <h1 class="text-lg font-bold">Dashboard Verifikator 2</h1>
                ...
                @foreach ($dokumen as $d)
                    <tr class="border-b hover:bg-gray-100">
                        ...
                        <td class="px-4 py-2 text-center">
                            <a href="{{ route('v2.show', $d->id) }}" class="bg-blue-600 text-white px-3 py-1 rounded hover:bg-blue-700">
                                Periksa
                            </a>
                        </td>
                    </tr>
