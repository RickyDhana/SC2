        ...
        function openDetailModal(id) {
            fetch(`/Jurubeli1_14/${id}/json`)
                ...
                .then(data => {
                    ...
                    document.getElementById('formSetujui').action = `/Jurubeli1_14/${data.id}/setujui`;
                    document.getElementById('formTolak').action = `/Jurubeli1_14/${data.id}/tolak`;
